...
For the dataset [cats]{.data} (@tbl-Cats) find the variance and standard deviation for weight of cats. Then find the variance and standard deviation separated by sex of the cat.
:::
...
To answer this question, first find how many standard deviations 45 is from the mean. From the previous [example](#exm-empirical-rule), we know $\mu=56$ and $\sigma=27.6$. For $x$=45, $z=\frac{45-56}{27.6}=-0.399$
...
Since this value is more than 2, then it is unusual to have 145 tornadoes in a year in Oklahoma.
