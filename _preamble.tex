...
\definecolor{OIindigo}{HTML}{3B3B98}
...
\newcommand{\Data}[1]{\textcolor{OIindigo}{\textit{#1}}}
...
% - for drawing tabs in the write up
\newcommand{\Tab}[1]{\colorbox{gray!15}{\texttt{\small #1}}}
