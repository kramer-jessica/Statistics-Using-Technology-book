...
::: {.callout-note appearance="simple" collapse="true" icon="none" title="Click here to see the Rguroo dialog"}
To create a side-by-side boxplot separated by the sex factor, move the [sex]{.var} factor variable to the Selected column in the Factor Variables section.
![Boxplot dialog in Rguroo](Rguroo_dialogs/Numerical_description/boxplot_cats_sex_dialog.png){width="500px"}
:::
