...
- The variable is `r var("x")`
- The defined term is `r def("standard deviation")`
- The function is `r fun("mean")`
- The dataset is `r data("Cars")`
- The answer is `r ans("42")`
