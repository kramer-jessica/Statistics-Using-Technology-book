...
<!--
::: {.example #determine-relationship title="Determining if there is a Relationship"}
...
::: {#Importing-Beer_data-to-Rguroo .callout-note appearance="simple" collapse="true" icon="none" title="![](Rguroo_Icons/R_circle_logo.svg){width=22px style='vertical-align:middle;'}  Importing beer_data to Rguroo"} 
...
:::: {#Adding-Regression-Line-to-Scatterplot-in-Rguroo  .callout-note appearance="simple" collapse="true" icon="none" title="![](Rguroo_Icons/R_circle_logo.svg){width=22px style='vertical-align:middle;'} Adding Regression Line to a Scatterplot"}
...
### Assumptions for the Validity of the Regression Equation and Line {#sec-assumption-validity-line}
...
### Assumptions for the validity of inference {#sec-assumption-validity-inference} 
...
:::{.example #find-regression-equation title="Find the Equation of the Regression Line"}

::: {#exm-find-regression-equation .example title="Find the Equation of the Regression Line"}
-->
...
7.  A sample of hot dogs was taken and the amount of sodium (in mg) and calories were measured. ("Data hotdogs" 2013) The Dataset are in @tbl-Hotdog. Create a scatter plot and find a regression equation between amount of calories and amount of sodium. Then use the regression equation to find the amount of sodium a hot dog has if it is 170 calories and if it is 120 calories. Which sodium level that you calculated do you think is closer to the true sodium level? Why?
...
**Code book for Dataset Cancer is below @tbl-Cancer.**
