...
This is test of my macros:
Inline examples (should be colored):
- The variable is [x]{.var}.
- The defined term is [standard deviation]{.def}.
- The descriptor is [Frequency]{.des}.
- The dataset is [Cars]{.data}.
- The dropdown selection is [Mean]{.dpd}.
- The function is [lm]{.fun}.
- The dialog name is [Descriptive Statistics]{.dialog}.
- The repository is [Rguroo Datasets]{.repo}.
- The answer is [42]{.ans}.
