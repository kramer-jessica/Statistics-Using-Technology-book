...
::: {.callout-note appearance="simple" collapse="true" icon="none" title="Click here to see the Rguroo dialog"}
![Logical Expression Dialog in Rguroo](Rguroo_dialogs/Numerical_description/subset_nomax_cats.png){width="500px"} ![Data Subset Dialog in Rguroo](Rguroo_dialogs/Numerical_description/logical_subset_nomax.png){width="500px"} ![Save As... Dataset View](Final_output/Rguroo_outputs/Numerical_Description/save_data_nomax.png)
:::
::::
...
<!-- The \<- is the way to indicate to r what the data set nomin is equivalent to what follows the symbol. Notice that it doesn't look like anything happened, but new data sets were created in the background.-->

Now you can find the mean and median of each new data set using the steps described [here](#Calculating-summary-stats-in-Rguroo) :
...
![New Dataset Dialog](Rguroo_dialogs/Numerical_description/new_dataset_dialog.png){width="500px"} ![Biology Class Dataset](Final_output/Rguroo_outputs/Numerical_Description/biology_dataset.png){width="500px"}
:::
::::
...
1.  **Before you begin:** Make sure you have already imported the [cholesterol]{.data} dataset into your **Data** Toolbox, as was shown [here](#Importing-cats-to-Rguroo) by selecting the [Statistics Using Technology - Kozak]{.repo} as shown in the figure @fig-kozak-repo. Cholesterol levels were collected from patients a certain number of days after they had a heart attack and are in @tbl-Cholesterol. Find the mean and median for cholesterol levels 2 days after the heart attack.
...
2.  **Before you begin:** Make sure you have already imported the [length]{.data} dataset into your **Data** Toolbox located in the [Statistics Using Technology - Kozak]{.repo}. The lengths (in kilometers) of rivers on the South Island of New Zealand and what body of water they flow into are listed in @tbl-Length (Lee, 1994). Find the mean and median length of rivers that flow into the Pacific Ocean and the mean and median length of rivers that flow into the Tasman Sea.
