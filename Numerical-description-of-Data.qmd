...
Both the sample variance and sample standard deviation can be found using technology. If using Rguroo, you would perform the same steps as described [here](#Calculating-summary-stats-in-Rguroo) and select [standard deviation]{.def} as shown in the figure @fig-sd-dialog.
```{r,echo=FALSE}
#| fig-alt: "Dialog box for standard deviation"
#| warning: FALSE
#| label: fig-sd-dialog
#| fig-cap: "Finding Standard Deviation Using Basic Summary Statistic"
#| out-width: "70%"
knitr::include_graphics("Final_output/Rguroo_dialogs/Numerical_Description/sd_cats_dialog.png")
```
