...
4. In the middle search box, type [beer]{.typein}, and select the [beer_data]{.data} dataset that appears in the lower panel.  
...
7. To view the dataset, double-click [beer_data]{.data} under the **Data** toolbox list.
...
#| out-width: "80%"
knitr::include_graphics("Final_output/Rguroo_outputs/Regression/AlcoholCalorieScatter.svg")
```
...
1. Open the Rguroo tab with your scatterplot of calories vs. alcohol content.  
...
#| out-width: "70%"
knitr::include_graphics("Final_output/Rguroo_outputs/Regression/AlcoholCalorieScatterLS.svg")
...
#| warning: FALSE
knitr::include_graphics("Final_output/Rguroo_outputs/Regression/AlcoholCalorieLSEstimates.png")
```
...
knitr::include_graphics("Final_output/Rguroo_outputs/Regression/AlcoholCalorieResiduals.png")
```
