...
![Basic Summary Statistic dialog in Rguroo](Final_output/Rguroo_dialogs/Numerical_description/summary_stat_dia_clean.png){width="500px"}
:::
::::
...
#| out-width: "70%"
knitr::include_graphics("Final_output/Rguroo_outputs/Numerical_Description/cats_summary_output.png")
```
...
::: {.callout-note appearance="simple" collapse="true" icon="none" title="Click here to see the Rguroo dialog"}
![Basic Summary Statistic dialog in Rguroo](Final_output/Rguroo_dialogs/Numerical_Description/cats_weight_sex.png){width="500px"}
:::
::::
...
#| out-width: "70%"
knitr::include_graphics("Final_output/Rguroo_outputs/Numerical_Description/cat_wt_sex_output.png")
```
...
#|   - "Output results"
#| out-width: "70%"
knitr::include_graphics(c("Final_output/Rguroo_dialogs/Numerical_Description/max_min_dialog.png",
"Final_output/Rguroo_outputs/Numerical_Description/max_min_output.png"))
```
...
::: {.callout-note appearance="simple" collapse="true" icon="none" title="Click here to see the Rguroo dialog"}
![Logical Expression Dialog in Rguroo](Final_output/Rguroo_dialogs/Numerical_description/subset_nomax_cats.png){width="500px"}
![Data Subset Dialog in Rguroo](Final_output/Rguroo_dialogs/Numerical_description/logical_subset_nomax.png){width="500px"}
![Save As... Dataset View](Final_output/Rguroo_outputs/Numerical_Description/save_data_nomax.png) 
:::
::::
...
#| out-width: "70%"
knitr::include_graphics("Final_output/images/centers_distribution.png")
```
...
![New Dataset Dialog](Final_output/Rguroo_dialogs/Numerical_description/new_dataset_dialog.png){width="500px"}
![Biology Class Dataset](Final_output/Rguroo_outputs/Numerical_Description/biology_dataset.png){width="500px"}
:::
::::
...
#|   - "Output results"
#| out-width: "70%"
knitr::include_graphics(c("Final_output/Final_output/Rguroo_dialogs/Numerical_Description/summary_stat_dialog_weight_mean.png",
"Final_output/Final_output/Rguroo_outputs/Numerical_Description/weight_mean_bio_grade.png"))
```
...
#| out-width: "70%"
knitr::include_graphics(c("Final_output/Rguroo_outputs/Numerical_Description/ex_4_1_8_dataset.png"))
```
...
#|   - "Output results"
#| out-width: "70%"
knitr::include_graphics(c("Final_output/Rguroo_dialogs/Numerical_Description/ex_4_1_8_a_dialog.png",
"Final_output/Rguroo_outputs/Numerical_Description/ex_4_1_8_a_output.png"))
```
...
#|   - "Output results"
#| out-width: "70%"
knitr::include_graphics(c("Final_output/Rguroo_dialogs/Numerical_Description/ex_4_1_8_b_dialog.png",
"Final_output/Rguroo_outputs/Numerical_Description/ex_4_1_8_b_output.png"))
```
...
1. **Before you begin:** Make sure you have already imported the [cholesterol]{.data} dataset into your **Data** Toolbox, as was shown [here](#Importing-cats-to-Rguroo) by selecting the [Statistics Using Technology - Kozak]{.repo} as shown in the figure @fig-kozak-repo. 
Cholesterol levels were collected from patients a certain number of days after they had a heart attack and are in @tbl-Cholesterol. Find the mean and median for cholesterol levels 2 days after the heart attack.
```{r,echo=FALSE}
...
#| out-width: "70%"
knitr::include_graphics("Final_output/Rguroo_dialogs/Numerical_Description/chol_data_repo.png")
```
...
2. **Before you begin:** Make sure you have already imported the [length]{.data} dataset into your **Data** Toolbox located in the [Statistics Using Technology - Kozak]{.repo}. 
The lengths (in kilometers) of rivers on the South Island of New Zealand and what body of water they flow into are listed in @tbl-Length (Lee, 1994). Find the mean and median length of rivers that flow into the Pacific Ocean and the mean and median length of rivers that flow into the Tasman Sea.
...
3. **Before you begin:** Make sure you have already imported the [pay]{.data} dataset into your **Data** Toolbox, located in the [Statistics Using Technology - Kozak]{.repo}. Print-O-Matic printing company's employees have salaries that are contained in @tbl-Pay.
...
4.  **Before you begin:** Make sure you have already imported the [cost]{.data} dataset into your **Data** Toolbox, located in the [Statistics Using Technology - Kozak]{.repo}. Print-O-Matic printing company spends specific amounts on fixed costs every month. The costs of those fixed costs are in a @tbl-Cost.
...
![Graph 3.1.2](Final_output/Rguroo_outputs/Numerical_Description/skewed_right_hist.png){fig-alt="histogram with bars on left tallest and then gradually getting shorter as you go to the right"}
...
![Graph 3.1.3](Final_output/Rguroo_outputs/Numerical_Description/skewed_left_hist.png){fig-alt="histogram with bars on left shortest and then gradually getting taller as you go to the right"}
...
Both the sample variance and sample standard deviation can be found using technology. If using Rguroo, you would perform the same steps as described [here](#Calculating-summary-stats-in-Rguroo) and select [standard deviation]{.def} and [variance]{.def} as shown in the figure @fig-sd-dialog.
```{r,echo=FALSE}
...
#| out-width: "70%"
knitr::include_graphics("Final_output/Rguroo_dialogs/Numerical_Description/sd_var_cats_dialog.png")
```
...
#| out-width: "70%"
knitr::include_graphics("Final_output/Rguroo_dialogs/Numerical_Description/sd_var_cats_output.png")
```
