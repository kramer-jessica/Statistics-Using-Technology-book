...
```{r NHANES6-density}
#| fig-alt: "Density plot of a person's weight. Appears to be symmetric, and maybe bell shaped"
#| warning: FALSE
#| echo: FALSE
#| label: fig-density-cap
#| fig-cap: "Density plot of the Weight of a Person"
gf_density(~Weight, data=NHANES, title="Weight of a Person", xlab="Weight")
```

@fig-density-cap looks somewhat symmetric, and maybe bell shaped.

Consider, the variable head circumference (HeadCirc) in the NHANES data frame. The density plot for this variable is @fig-HeadCirc-density

```{r headcirc6-density}
#| fig-alt: "Density plot of head circumference of a person. Appears to be skewed left."
#| warning: FALSE
#| label: fig-HeadCirc-density
#| echo: FALSE
#| fig-cap: "Density plot of head circumference of a person"
gf_density(~HeadCirc, data=NHANES, title="Head Circumference of a Person", xlab = "Head Cicumference")
```

@fig-HeadCirc-density looks somewhat skewed left.

Now consider the variable BMI from the NHANES data frame. The density plot is

```{r NHANES6a-density}
#| fig-alt: "Density plot of BMI of a person that is skewed right."
#| warning: FALSE
#| echo: FALSE
#| label: fig-BMI-density
#| fig-cap: "Density Plot of BMI of a Person"
gf_density(~BMI, data=NHANES, title = "BMI of a Person", xlab="Body Mass Index")
```

This density plot @fig-BMI-density appears to be skewed right

Now consider the variable SmokeAge. Its density plot is @fig-Smoking-density

```{r NHANES6b-density}
#| fig-alt: "Density plot of age when a person started smoking. Appears to be bimodal."
#| warning: FALSE
#| echo: FALSE
#| label: fig-Smoking-density
#| fig-cap: "Density Plot of Age when Person Started Smoking"
gf_density(~SmokeAge, data=NHANES, title="Age when a Person Started Smoking", xlab="Age")
```

This distribution appears to be bimodal.

lastly, consider the variable Pulse. The density plot is @fig-Pulse-density

```{r NHANES6c-density}
#| fig-alt: "Density plot of pulse rate of a person. Appears to be symmetric."
#| warning: FALSE
#| echo: FALSE
#| label: fig-Pulse-density
#| fig-cap: "Density Plot of Pulse Rate of a person"
gf_density(~Pulse, data=NHANES, title = "Pulse Rate of a Person", xlab="Pulse")
```
...
@fig-normal-curvea and @fig-normal-curveb show two different normal curves drawn on the same scale. Both have $\mu=2$ but the one in @fig-normal-curvea has a standard deviation of 1 and the one in @fig-normal-curveb has a standard deviation of 4. Notice that the larger standard deviation makes the graph wider (more spread out) and shorter.

```{r normal-curvea}
#| fig-alt: "Bell curve with mean 2 and standard deviation of 1"
#| warning: FALSE
#| echo: FALSE
#| label: fig-normal-curvea
#| fig-cap: "Normal curve with mean 2 and standard deviation 1"
...
```{r normal-curveb}
#| fig-alt: "Bell curve with mean 2 and standard deviation of 4"
#| warning: FALSE
#| echo: FALSE
#| label: fig-normal-curveb
#| fig-cap: "Normal curve with mean 2 and standard deviation 4"
...
![Empirical Rule Graph](Empirical_rule.png){fig-alt="Empirical Rule graph with 68% of data between -1 and 1 standard deviation of mean, 95% between -2 and 2, and 99.7% between -3 and 3"}
...
Now, draw a picture @fig-normal-curve61.

```{r normal-curve61}
#| fig-alt: "Density plot of pregnancy length. Normally distributed with mean 272 and standard deviation 9. Shaded above 280"
#| warning: FALSE
#| echo: FALSE
#| label: fig-normal-curve61
#| fig-cap: "Normally distributed with mean 272 and standard deviation 9, and P(x>280)"
...
Now, draw a picture @fig-normal-curve62.

```{r normal-curve62}
#| fig-alt: "Density plot of pregnancy length. Normally distributed with mean 272 and standard deviation 9. Shaded below 250"
#| warning: FALSE
#| echo: FALSE
#| label: fig-normal-curve62
#| fig-cap: "Density plot of pregnancy length. Normally distributed with mean 272 and standard deviation 9, and P(x<250)"
...
Now draw a picture @fig-normal-curve63.
...
#| fig-alt: "Density plot of pregnancy length. Normally distributed with mean 272 and standard deviation 9. Shaded from 265 to 280"
#| warning: FALSE
#| echo: FALSE
#| label: fig-normal-curve63
#| fig-cap: "Density plot of pregnancy length. Normally distributed with mean 272 and standard deviation 9, and P(265<x<280)"
...
The probability of a pregnancy lasting between 265 days and 280 days is $P(265<x<280)=0.187$. To find the area between two values on the normal distribution, first, find the area to the left of the lower value, Graphically, this looks like @fig-normal-curve-preg

```{r normal-curve-preg}
#| fig-alt: "Density plot of pregnancy length. Normally distributed with mean 272 and standard deviation 9. Shaded below 265"
#| warning: FALSE
#| echo: FALSE
#| label: fig-normal-curve-preg
#| fig-cap: "Density plot of pregnancy length. Normally distributed with mean 272 and standard deviation 9, and P(x<265)"
...
Now find the area less than 280. Graphically this looks like @fig-normal-curve-preg1

```{r normal-curve-preg1}
#| fig-alt: "Density plot of pregnancy length. Normally distributed with mean 272 and standard deviation 9. Shaded below 280"
#| warning: FALSE
#| echo: FALSE
#| label: fig-normal-curve-preg1
#| fig-cap: "Density plot of pregnancy length. Normally distributed with mean 272 and standard deviation 9, and P(x<280)"
...
Looking at the three figures, if you take the area in @fig-normal-curve-preg1 and subtract the area in @fig-normal-curve-preg you get the area in @fig-normal-curve63. In rStudio, the way to find the probability the probability of a pregnancy lasting between 265 days and 280 days, $P(265<x<280)=0.595$ use the following command
...
Now, draw a picture @fig-normal-curve-SAT

```{r normal-curve-SAT}
#| fig-alt: "Density plot of SAT mathematics score. Normally distributed with mean 514 and standard deviation 117. Shaded above 700"
#| warning: FALSE
#| echo: FALSE
#| label: fig-normal-curve-SAT
#| fig-cap: "Density plot of SAT mathematics score. Normally distributed with mean 514 and standard deviation 117 and P(x>700)"
...
Now, draw a picture @fig-normal-curve-SAT1

```{r normal-curve-SAT1}
#| fig-alt: "Density plot of SAT mathematics score. Normally distributed with mean 514 and standard deviation 117. Shaded below 400"
#| warning: FALSE
#| echo: FALSE
#| label: fig-normal-curve-SAT1
#| fig-cap: "Density plot of SAT mathematics score. Normally distributed with mean 514 and standard deviation 117 and P(x<400)"
...
Now, draw a picture @fig-normal-curve-SAT2

```{r normal-curve-SAT2}
#| fig-alt: "Density plot of SAT mathematics score. Normally distributed with mean 514 and standard deviation 117. Shaded from 514 to 650"
#| warning: FALSE
#| echo: FALSE
#| label: fig-normal-curve-SAT2
#| fig-cap: "Density plot of SAT mathematics score. Normally distributed with mean 514 and standard deviation 117 and P(514<x<650)"
...
### Homework for Normal Distribution Section
...
### **To create a density plot on rStudio:**
...
### **To create a normal quantile plot on rStudio**
...
In Kiama, NSW, Australia, there is a blowhole. The data in @tbl-Eruption are times in seconds between eruptions ("Kiama blowhole eruptions," 2013). Do the data come from a population that is normally distributed?
...
The density plot produced is in @fig-blowhole-density

```{r blowhole-density}
#| fig-alt: "Density plot of eruption times for Kiama blowhole. Appears skewed right."
#| warning: FALSE
#| label: fig-blowhole-density
#| fig-cap: "Density Plot of Eruption Times for Kiama Blowhole"
...
The normal quantile plot is in @fig-blowhole-qq

```{r blowhole-qq}
#| fig-alt: "Normal quantile plot of eruption times for Kiama blowhole. Appears exponential."
#| warning: FALSE
#| label: fig-blowhole-qq
#| fig-cap: "Normal Quantile Plot of Eruption Times for Kiama blowhole."
gf_qq(~Interval, data=Eruption, title="Eruption times for Kiama Blowhole")
```

@fig-blowhole-qq looks more like an exponential growth than linear.
...
The US National Center for Health Statistics (NCHS) conducted a series of health and nutrition surveys called NHANES. One of the many variables in NHANES is pulse. Determine if pulse is a normally distributed variable. The NHANES data frame is @tbl-NHANES.
...
The density plot is in @fig-pulse-density

```{r pulse-density}
#| fig-alt: "Density plot of pulse rate. Appears to be bell shapped."
#| warning: FALSE
#| label: fig-pulse-density
#| fig-cap: "Density plot of Pulse Rate (bpm)"
...
The normal quantile plot is in @fig-pulse-qq

```{r pulse-qq}
#| fig-alt: "Normal quantile plot of pulse rate. Appears to be linear."
#| warning: FALSE
#| label: fig-pulse-qq
#| fig-cap: "Normal Quantile Plot of Pulse Rate (bmp)"
gf_qq(~Pulse, data=NHANES, title="Pulse Rate") 
```

@fig-pulse-qq looks fairly linear.
...
### Homework for Assessing Normality Section

1.  Cholesterol data was collected on patients four days after having a heart attack. The data is in @tbl-Cholesterol. Assess if the data is from a population that is normally distributed.

**Code Book for Cholesterol** See is below @tbl-Cholesterol.
...
3.  The WHO MONICA Project collected blood pressure data for people in China (Kuulasmaa, Hense & Tolonen, 1998). Data based on information from the study is in @tbl-BP. Determine if the data is from a population that is normally distributed.
...
4.  Annual rainfalls for Sydney, Australia are given in @tbl-Annual ("Annual maximums of," 2013). Can you assume rainfall is normally distributed?
...
The NHANES data frame has the pulse rates for approximately 50,000 individuals. The random variable is $x$ = pulse rate. The probability distribution of this random variable is presented in @fig-NHANES6h-density. Although pulse rates from 50,000 individuals isn't the entire population, the sample is most likely a good representation of the population. Thus, it is safe to assume the population is normally distributed. An estimate for the population mean is 73.6 pbm, and the population standard deviation estimate is 12.2 bpm.

```{r NHANES6h-density}
#| fig-alt: "Density plot of pulse rate. Appears to be normally distributed."
#| warning: FALSE
#| label: fig-NHANES6h-density
#| fig-cap: "Distribution of Pulse Rate"
...
Now suppose you took another random sample of size 10 and found the mean pulse rate for that sample. Repeat this process 100 times. At this point you would basically have a new sample of 100 mean pulse rates. You could assess how this sample is distributed by creating a density plot @fig-NHANES6e-density

```{r NHANES6e-density}
#| fig-alt: "Density plot of sample means when sample size is 10. Appears to be bell shaped."
#| warning: FALSE
#| label: fig-NHANES6e-density
#| fig-cap: "Density Plot of Sample Means When n = 10"
...
This density plot of the sampling distribution is displayed in @fig-NHANES6f-density

```{r NHANES6f-density}
#| fig-alt: "Density plot of sample means when sample size is 50. Appears to be bell shaped."
#| warning: FALSE
#| label: fig-NHANES6f-density
#| fig-cap: "Density Plot of Sample Means When n = 50"
Trials <- do(100) * { NHANES |>
    sample_n(size = 50) |>
    df_stats( ~Pulse, means = mean) }
...
```{r NHANES6-random}
#| fig-alt: "Density plot of mean age a person starts to smoke of a sample of size 50. Appears to be bell shaped."
#| warning: FALSE
#| echo: FALSE
#| label: fig-NHANES6-random-density
#| fig-cap: "Density Plot of Age When Person Started Smoking when sample size is 50."
Trials <- do(100) * { NHANES |>
    sample_n(size = 50) |>
    df_stats( ~SmokeAge, means = mean) }
gf_density( ~means, data = Trials, title = "Density plot of sample means age a person starts smoking with sample size 50.")%>% gf_lims(x=c(13,24))
df_stats(~means, data=Trials, mean, sd) 
```
...
### Homework for Sampling Distribution and the Central Limit Theorem Section
