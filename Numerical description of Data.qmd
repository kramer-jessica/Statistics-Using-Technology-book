...
::: {.callout-note appearance="simple" collapse="true" icon="none" title="![](Rguroo_Icons/R_circle_logo.svg){width=22px style='vertical-align:middle;'} Calculating the Mean and Median Weight of Cats"}
...
![Basic Summary Statistic dialog in Rguroo](Final_output/Rguroo_images/Numerical_Description/summary_stat_dia_clean.png){width=500px}
:::
:::
...
```{r statistics-cats3, echo = FALSE, evaluate = FALSE}
...
```{r cats1-data, echo = FALSE, evaluate = FALSE}
#??cats
```
...
::: {.callout-note appearance="simple" collapse="true" icon="none" title="Click here to see the Rguroo dialog"}
![Basic Summary Statistic dialog in Rguroo](Final_output/Rguroo_images/Numerical_Description/cats_weight_sex.png){width=500px}
:::
:::
...
```
```{r statistics-cats-sex2, echo = FALSE, evaluate = FALSE}
...
#|   - "Output results"
#| out-width: "70%"
knitr::include_graphics(c("Final_output/Rguroo_images/Numerical_Description/max_min_dialog.png",
