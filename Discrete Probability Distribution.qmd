...
b.  The number of A's you recieve on your college transcript.
...
b.  The number of A's you recieve on your college transcript is discrete since it is something you count.
:::
...
: Distribution for number of texts recieved in one hour {#tbl-texts tbl-alt="Table showing values of the random variable as 0, 1, 2, 3, 4, and 5. The probabilities in the second column are 0.10, 0.15, 0.25, 0.33, 0.12, and 0.10"}
...
Click to expand the box below see how to create a probabilty histogram for [table_5_1_1]{.data}.
...
**need to start from here - need**

probability histogram
example: constructing probability histogram from dataset in Rguroo

### Mean and Expected Value

### Unusual Events

example: use example given with kids, but rewrite questions (exactly, at least, at most, etc)
...
The 2010 U.S. Census found the chance of a household being a certain size. The data is in @tbl-Household (\\"Households by age,\\" 2013). Note, the category 7 is really 7 or more people in the household. Draw the probability distribution and find the mean, variance, and standard deviation.
...
You can give a probability distribution in table form (as in @tbl-Household) or as a graph. The graph looks like a histogram. To graph the histogram, use the following commands and process in rStudio.
...
```{r }
#| fig-alt: "Histogram of size of family that has higher bars on the left and lower bars on the right"
#| warning: FALSE
#| label: fig-discrete-histogram
#| fig-cap: "Histogram of Household Size from U.S. Census of 2010"
...
Notice this graph @fig-discrete-histogram is skewed right, which means that most families have around 2 people in them and larger families become more and more rare.
...
The 2010 U.S. Census found the chance of a household being a certain size. The data is in @tbl-Household (\\"Households by age,\\" 2013). Note, the category 7 is really 7 or more people in the household.
...
### Homework for Basics of Probability Distributions Section
...
#| label: tbl-Days
#| tbl-cap: "Nuumber of Days to fix Eyeglasses"
Days<- read.csv(
...
4.  An LG Dishwasher, which costs \\\$800, has a 20% chance of needing to be replaced in the first 2 years of purchase. A two-year extended warranty costs \\\$112.10 on a dishwasher. What is the expected value of the extended warranty assuming it is replaced in the first 2 years?

## Binomial Probability Distribution {#sec-binomial-probability-distribution}
...
### Homework for Binomial Probability Distribution Section
...
```{r }
#| fig-alt: "Histogram of number of people with green eyes that has a high bar on the left and low bars on the right"
#| label: fig-Green
#| fig-cap: "Histogram of Number of People with Green Eyes"
...
Notice this graph @fig-Green is skewed right.
...
### Homework for Mean and Standard Deviation of Binomial Distribution Section
