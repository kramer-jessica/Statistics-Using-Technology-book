...
::: {.callout-note appearance="simple" collapse="true" icon="none" title="![](Rguroo_Icons/R_circle_logo.svg){width=22px style='vertical-align:middle;'}  For instructions to import and view the Beer dataset in your Rguroo account, click here"} 

1. Go to your Rguroo account. 
2. Open the **Data** toolbox.
3. Click on [Data Import]{.dpd} dropdown and select [Dataset Repository]{.fun}.
5. In the searchbox on the top type in the keyword [kozak]{.typein}. Then select the ``_Statistics Using Technology - Kozak_'' repository.
6. In the middle _searchbox_ type in [beer]{.typein} and select the [beer_data]{.data} dataset.
7. Click the [Import]{.button} button. The dataset will be imported to your Rguroo account.
8. Click the [Close]{.button} button to close the Rguroo dialog.
9. To view the dataset, click on the [beer_data]{.data} under the **Data** toolbox.
:::
...
::: {.callout-note appearance="simple" collapse="true" icon="none" title="![](Rguroo_Icons/R_circle_logo.svg){width=22px style='vertical-align:middle;'} To see how to create the scatterplot of calories vs. alcohol content in Rguroo, click here"}
1. Go to your Rguroo account. Make sure that you have already imported the [beer_data]{.data} dataset by following the instructions given above.  
...
#| out-width: "70%"
knitr::include_graphics("Rguroo_outputs/Regression/AlcoholCaloryScatter.svg")
```

This scatter plot shown in @fig-Beer-point looks fairly linear.
